...
public class Player_AimController : MonoBehaviour
{
    ...
    [SerializeField] private float offsetChangeRate = 6f;
    ...
    private void UpdateAimPosition()
    {
        ...
        Vector3 newAimPostion = isAimingPrecisly ? aim.position : transform.position;

        aim.position = new Vector3(aim.position.x, newAimPostion.y + AdjustedOffsetY(), aim.position.z);
    }
